...
<html>
 <head>
  <title>GESTIONNAIRE DES DOSSIERS / FICHIERS</title>
 ...
 <body>
  <br /><br />
  <img src="logo.png" width="15%" style="margin-left: 7%">
  <div class="container">
   <h2 align="center" style="background-color: gray"><b>GESTIONNAIRE DES DOSSIERS / FICHIERS</b></h2>
   <br />
   <div align="right">
    <button type="button" name="create_folder" id="create_folder" class="btn btn-success">Créer un Dossier</button>
   </div>
   <br />
...
<div id="uploadModal" class="modal fade" role="dialog">
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal">&times;</button>
    <h4 class="modal-title">Téléchargé Fichier</h4>
   </div>
   <div class="modal-body">
    <form method="post" id="upload_form" enctype='multipart/form-data'>
     ...
     <input type="submit" name="upload_button" class="btn btn-info" value="Téléchargé" />
    </form>
   </div>
   <div class="modal-footer">
    <button type="button" class="btn btn-default" data-dismiss="modal">Fermé</button>
...
$(document).ready(function(){
 ...
 $(document).on('click', '#create_folder', function(){
  ...
  $('#old_name').val('');
  $('#change_title').text("Créer un Dossier");
 });
 ...
 $(document).on('click', '#folder_button', function(){
  ...
  {
   alert("Entrer un nom pour votre Dossier");
  }
 });
 ...
 $(document).on("click", ".update", function(){
  ...
  $('#action').val("change");
  $('#folderModal').modal("show");
  $('#folder_button').val('Mettre à jour');
  $('#change_title').text("Changer Nom du Dossier");
 });
 
 $(document).on("click", ".delete", function(){
  var folder_name = $(this).data("name");
  var action = "delete";
  if(confirm("Voulez vous bien le supprimer ?"))
  {
   $.ajax({
    url:"action.php",
    method:"POST",
 ...
 $(document).on('click', '.remove_file', function(){
  ...
  if(confirm("Voulez vous bien supprimer ce Fichier?"))
  {
   $.ajax({
    url:"action.php",
    method:"POST",
